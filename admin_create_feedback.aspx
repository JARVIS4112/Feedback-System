    ...
    <table class="auto-style8">
        ...
        <tr>
            ...
            <td class="auto-style23" rowspan="3">
                <asp:Calendar ID="Calendar1" runat="server" OnSelectionChanged="Calendar1_SelectionChanged" Visible="False" style="z-index: 1; left: 370px; top: 39px; position: absolute; height: 213px; width: 285px"></asp:Calendar>
            </td>
        </tr>
        <tr>
