    ...
    <div class="auto-style1">
        ...
        <table class="auto-style2">
            ...
            <tr>
                ...
                <td class="auto-style6">
                    <asp:TextBox ID="dept_id" runat="server" Width="250px"></asp:TextBox>
                </td>
                <td class="auto-style21">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="dept_id" CssClass="auto-style10" ErrorMessage="Department ID required"></asp:RequiredFieldValidator>
                    <br />
                </td>
            </tr>
            <tr>
                ...
                <td class="auto-style18">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="DropDownList1" CssClass="auto-style10" ErrorMessage="Please select any status"></asp:RequiredFieldValidator>
                    <br />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="auto-style17">
                    <asp:TextBox ID="rpassword" runat="server" TextMode="Password" Width="250px"></asp:TextBox>
                </td>
                <td class="auto-style18">
