...
{
    MySqlConnection con = new MySqlConnection(@"server=127.0.0.1;user id = root;pwd = Jarvis@4112; database=audit_form;allowuservariables=True");
    MySqlConnection con1 = new MySqlConnection(@"server=127.0.0.1;user id = root;pwd = Jarvis@4112; database=adminlog;allowuservariables=True");
